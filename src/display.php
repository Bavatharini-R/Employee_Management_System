...
<style>
body{
	background-image:linear-gradient(rgba(71,71,71,0.7),rgba(71,71,71,0.7)),url("img/display.jpg");
...
<div class="card-header bg-dark">
				<h1 class="text-white text-center">Employee Details</h1>
			</div><br>
...
<div class="container">
	<div class="col-md-12 text-center"><br>
		...
		<a href="search.php" class="col-lg-3"><button class="btn btn-success col-lg-3">Search</button></a> 
